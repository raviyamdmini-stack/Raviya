...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'raviyamdmini-stack';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'Raviya';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
